...
DBUS_INTERFACE_SETTINGS_CONNECTION: str = "org.freedesktop.NetworkManager.Settings.Connection"
DBUS_INTERFACE_SETTINGS_CONNECTION_SECRETS: str = "org.freedesktop.NetworkManager.Settings.Connection.Secrets"
...
DBUS_INVALID_VPN_CONNECTION: str = "org.freedesktop.NetworkManager.VPNConnections.InvalidVPNConnection"
DBUS_NO_ACTIVE_VPN_CONNECTION: str = "org.freedesktop.NetworkManager.VPNConnections.NoActiveVPNConnection"
DBUS_NO_VPN_CONNECTIONS: str = "org.freedesktop.NetworkManager.VPNConnections.NoVPNConnections"
...
DBUS_PATH_SETTINGS_CONNECTION: str = "/org/freedesktop/NetworkManager/Settings/Connection"
...
DEVICE_IPVLAN_MODE: str = "mode"
DEVICE_IPVLAN_PARENT: str = "parent"
DEVICE_IPVLAN_PRIVATE: str = "private"
DEVICE_IPVLAN_VEPA: str = "vepa"
...
ETHTOOL_OPTNAME_FEATURE_RX_UDP_TUNNEL_PORT_OFFLOAD: str = "feature-rx-udp_tunnel-port-offload"
...
ETHTOOL_OPTNAME_FEATURE_TX_GRE_CSUM_SEGMENTATION: str = "feature-tx-gre-csum-segmentation"
...
ETHTOOL_OPTNAME_FEATURE_TX_SCATTER_GATHER_FRAGLIST: str = "feature-tx-scatter-gather-fraglist"
...
ETHTOOL_OPTNAME_FEATURE_TX_TCP_MANGLEID_SEGMENTATION: str = "feature-tx-tcp-mangleid-segmentation"
ETHTOOL_OPTNAME_FEATURE_TX_TCP_SEGMENTATION: str = "feature-tx-tcp-segmentation"
ETHTOOL_OPTNAME_FEATURE_TX_TUNNEL_REMCSUM_SEGMENTATION: str = "feature-tx-tunnel-remcsum-segmentation"
ETHTOOL_OPTNAME_FEATURE_TX_UDP_SEGMENTATION: str = "feature-tx-udp-segmentation"
ETHTOOL_OPTNAME_FEATURE_TX_UDP_TNL_CSUM_SEGMENTATION: str = "feature-tx-udp_tnl-csum-segmentation"
...
ETHTOOL_OPTNAME_FEC_MODE: str = "fec-mode"
...
SETTING_802_1X_PHASE2_CLIENT_CERT_PASSWORD_FLAGS: str = "phase2-client-cert-password-flags"
...
SETTING_802_1X_PHASE2_PRIVATE_KEY_PASSWORD_FLAGS: str = "phase2-private-key-password-flags"
...
SETTING_BRIDGE_MULTICAST_QUERY_RESPONSE_INTERVAL: str = "multicast-query-response-interval"
...
SETTING_BRIDGE_MULTICAST_STARTUP_QUERY_INTERVAL: str = "multicast-startup-query-interval"
...
SETTING_CONNECTION_IP_PING_ADDRESSES: str = "ip-ping-addresses"
SETTING_CONNECTION_IP_PING_ADDRESSES_REQUIRE_ALL: str = "ip-ping-addresses-require-all"
SETTING_CONNECTION_IP_PING_TIMEOUT: str = "ip-ping-timeout"
...
SETTING_GSM_INITIAL_EPS_BEARER_NOAUTH: str = "initial-eps-bearer-noauth"
SETTING_GSM_INITIAL_EPS_BEARER_PASSWORD: str = "initial-eps-bearer-password"
SETTING_GSM_INITIAL_EPS_BEARER_PASSWORD_FLAGS: str = "initial-eps-bearer-password-flags"
SETTING_GSM_INITIAL_EPS_BEARER_REFUSE_CHAP: str = "initial-eps-bearer-refuse-chap"
SETTING_GSM_INITIAL_EPS_BEARER_REFUSE_EAP: str = "initial-eps-bearer-refuse-eap"
SETTING_GSM_INITIAL_EPS_BEARER_REFUSE_MSCHAP: str = "initial-eps-bearer-refuse-mschap"
SETTING_GSM_INITIAL_EPS_BEARER_REFUSE_MSCHAPV2: str = "initial-eps-bearer-refuse-mschapv2"
SETTING_GSM_INITIAL_EPS_BEARER_REFUSE_PAP: str = "initial-eps-bearer-refuse-pap"
SETTING_GSM_INITIAL_EPS_BEARER_USERNAME: str = "initial-eps-bearer-username"
...
SETTING_IP4_CONFIG_DHCP_IPV6_ONLY_PREFERRED: str = "dhcp-ipv6-only-preferred"
...
SETTING_IPVLAN_MODE: str = "mode"
SETTING_IPVLAN_PARENT: str = "parent"
SETTING_IPVLAN_PRIVATE: str = "private"
SETTING_IPVLAN_SETTING_NAME: str = "ipvlan"
SETTING_IPVLAN_VEPA: str = "vepa"
...
SETTING_IP_CONFIG_DHCP_SEND_HOSTNAME_V2: str = "dhcp-send-hostname-v2"
...
SETTING_IP_CONFIG_ROUTED_DNS: str = "routed-dns"
...
SETTING_IP_CONFIG_SHARED_DHCP_LEASE_TIME: str = "shared-dhcp-lease-time"
SETTING_IP_CONFIG_SHARED_DHCP_RANGE: str = "shared-dhcp-range"
...
SETTING_WIRELESS_CHANNEL_WIDTH: str = "channel-width"
...
def ethtool_optname_is_channels(optname: typing.Optional[str] = None) -> bool: ...
def ethtool_optname_is_coalesce(optname: typing.Optional[str] = None) -> bool: ...
def ethtool_optname_is_eee(optname: typing.Optional[str] = None) -> bool: ...
def ethtool_optname_is_feature(optname: typing.Optional[str] = None) -> bool: ...
def ethtool_optname_is_fec(optname: typing.Optional[str] = None) -> bool: ...
def ethtool_optname_is_pause(optname: typing.Optional[str] = None) -> bool: ...
def ethtool_optname_is_ring(optname: typing.Optional[str] = None) -> bool: ...
def ip_route_attribute_validate(name: str, value: GLib.Variant, family: int) -> typing.Tuple[bool, bool]: ...
def ip_route_get_variant_attribute_spec() -> VariantAttributeSpec: ...
def ip_routing_rule_from_string(str: str, to_string_flags: IPRoutingRuleAsStringFlags, extra_args: typing.Optional[dict[None, None]] = None) -> IPRoutingRule: ...
def keyfile_read(keyfile: GLib.KeyFile, base_dir: str, handler_flags: KeyfileHandlerFlags, handler: typing.Optional[typing.Callable[..., bool]] = None, *user_data: typing.Any) -> Connection: ...
def keyfile_write(connection: Connection, handler_flags: KeyfileHandlerFlags, handler: typing.Optional[typing.Callable[..., bool]] = None, *user_data: typing.Any) -> GLib.KeyFile: ...
def manager_error_quark() -> int: ...
def range_from_str(str: str) -> Range: ...
def secret_agent_error_quark() -> int: ...
def settings_error_quark() -> int: ...
def sriov_vf_attribute_validate(name: str, value: GLib.Variant) -> typing.Tuple[bool, bool]: ...
def utils_ap_mode_security_valid(type: UtilsSecurityType, wifi_caps: DeviceWifiCapabilities) -> bool: ...
def utils_base64secret_decode(base64_key: str, required_key_len: int) -> typing.Tuple[bool, int]: ...
def utils_bin2hexstr(src: typing.Sequence[int], final_len: int) -> str: ...
def utils_bond_mode_int_to_string(mode: int) -> str: ...
def utils_bond_mode_string_to_int(mode: str) -> int: ...
def utils_check_virtual_device_compatibility(virtual_type: typing.Type[typing.Any], other_type: typing.Type[typing.Any]) -> bool: ...
def utils_ensure_gtypes() -> None: ...
def utils_enum_from_str(type: typing.Type[typing.Any], str: str) -> typing.Tuple[bool, int, str]: ...
def utils_enum_get_values(type: typing.Type[typing.Any], from_: int, to: int) -> list[str]: ...
def utils_enum_to_str(type: typing.Type[typing.Any], value: int) -> str: ...
def utils_escape_ssid(ssid: typing.Sequence[int]) -> str: ...
def utils_file_is_certificate(filename: str) -> bool: ...
def utils_file_is_pkcs12(filename: str) -> bool: ...
def utils_file_is_private_key(filename: str) -> typing.Tuple[bool, bool]: ...
def utils_file_search_in_paths(progname: str, try_first: typing.Optional[str], paths: typing.Optional[str], file_test_flags: GLib.FileTest, predicate: typing.Callable[..., bool], *user_data: typing.Any) -> str: ...
...
def utils_hwaddr_aton(asc: str, buffer: typing.Sequence[int]) -> int: ...
...
def utils_hwaddr_ntoa(addr: typing.Sequence[int]) -> str: ...
def utils_hwaddr_valid(asc: str, length: int) -> bool: ...
def utils_iface_valid_name(name: typing.Optional[str] = None) -> bool: ...
def utils_ip4_addresses_from_variant(value: GLib.Variant) -> typing.Tuple[list[IPAddress], str]: ...
def utils_ip4_addresses_to_variant(addresses: typing.Sequence[IPAddress], gateway: typing.Optional[str] = None) -> GLib.Variant: ...
...
def utils_ip4_routes_to_variant(routes: typing.Sequence[IPRoute]) -> GLib.Variant: ...
def utils_ip6_addresses_from_variant(value: GLib.Variant) -> typing.Tuple[list[IPAddress], str]: ...
def utils_ip6_addresses_to_variant(addresses: typing.Sequence[IPAddress], gateway: typing.Optional[str] = None) -> GLib.Variant: ...
...
def utils_ip6_routes_to_variant(routes: typing.Sequence[IPRoute]) -> GLib.Variant: ...
def utils_ip_addresses_from_variant(value: GLib.Variant, family: int) -> list[IPAddress]: ...
def utils_ip_addresses_to_variant(addresses: typing.Sequence[IPAddress]) -> GLib.Variant: ...
def utils_ip_routes_from_variant(value: GLib.Variant, family: int) -> list[IPRoute]: ...
def utils_ip_routes_to_variant(routes: typing.Sequence[IPRoute]) -> GLib.Variant: ...
def utils_ipaddr_valid(family: int, ip: str) -> bool: ...
def utils_is_empty_ssid(ssid: typing.Sequence[int]) -> bool: ...
def utils_is_json_object(str: str) -> bool: ...
def utils_is_uuid(str: typing.Optional[str] = None) -> bool: ...
def utils_is_valid_iface_name(name: typing.Optional[str] = None) -> bool: ...
...
def utils_same_ssid(ssid1: typing.Sequence[int], ssid2: typing.Sequence[int], ignore_trailing_null: bool) -> bool: ...
def utils_security_valid(type: UtilsSecurityType, wifi_caps: DeviceWifiCapabilities, have_ap: bool, adhoc: bool, ap_flags: 80211ApFlags, ap_wpa: 80211ApSecurityFlags, ap_rsn: 80211ApSecurityFlags) -> bool: ...
def utils_sriov_vf_from_str(str: str) -> SriovVF: ...
def utils_sriov_vf_to_str(vf: SriovVF, omit_index: bool) -> str: ...
def utils_ssid_to_utf8(ssid: typing.Sequence[int]) -> str: ...
...
def vpn_editor_plugin_load_from_file(plugin_name: str, check_service: str, check_owner: int, check_file: typing.Callable[..., bool], *user_data: typing.Any) -> VpnEditorPlugin: ...
...
class AccessPoint(Object):
    ...
    class Props:
        ...
        max_bitrate: int
        mode: 80211Mode
        rsn_flags: 80211ApSecurityFlags
        ssid: GLib.Bytes
        strength: int
        wpa_flags: 80211ApSecurityFlags
        client: typing.Optional[Client]
        path: str
    props: Props = ...
    def connection_valid(self, connection: Connection) -> bool: ...
    def filter_connections(self, connections: typing.Sequence[Connection]) -> list[Connection]: ...
    def get_bandwidth(self) -> int: ...
    def get_bssid(self) -> str: ...
    def get_flags(self) -> 80211ApFlags: ...
    def get_frequency(self) -> int: ...
    def get_last_seen(self) -> int: ...
    def get_max_bitrate(self) -> int: ...
    def get_mode(self) -> 80211Mode: ...
    def get_rsn_flags(self) -> 80211ApSecurityFlags: ...
    def get_ssid(self) -> GLib.Bytes: ...
    def get_strength(self) -> int: ...
    def get_wpa_flags(self) -> 80211ApSecurityFlags: ...
...
class ActiveConnection(Object):
    ...
    class Props:
        ...
        controller: typing.Optional[Device]
        default: bool
        default6: bool
        devices: list[Device]
...
class BridgeVlan(GObject.GBoxed):
    ...
    def get_vid_range(self) -> typing.Tuple[bool, int, int]: ...
...
class Client(GObject.Object, Gio.AsyncInitable, Gio.Initable):
    ...
    props: Props = ...
    def __init__(self, connectivity_check_enabled: bool = ...,
                 dbus_connection: Gio.DBusConnection = ...,
                 instance_flags: int = ...,
                 networking_enabled: bool = ...,
                 wimax_enabled: bool = ...,
                 wireless_enabled: bool = ...,
                 wwan_enabled: bool = ...) -> None: ...
    def activate_connection_async(self, connection: typing.Optional[Connection] = None, device: typing.Optional[Device] = None, specific_object: typing.Optional[str] = None, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def activate_connection_finish(self, result: Gio.AsyncResult) -> ActiveConnection: ...
    def add_and_activate_connection2(self, partial: typing.Optional[Connection], device: typing.Optional[Device], specific_object: typing.Optional[str], options: GLib.Variant, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def add_and_activate_connection2_finish(self, result: Gio.AsyncResult) -> typing.Tuple[ActiveConnection, GLib.Variant]: ...
    def add_and_activate_connection_async(self, partial: typing.Optional[Connection] = None, device: typing.Optional[Device] = None, specific_object: typing.Optional[str] = None, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def add_and_activate_connection_finish(self, result: Gio.AsyncResult) -> ActiveConnection: ...
    def add_connection2(self, settings: GLib.Variant, flags: SettingsAddConnection2Flags, args: typing.Optional[GLib.Variant], ignore_out_result: bool, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def add_connection2_finish(self, result: Gio.AsyncResult) -> typing.Tuple[RemoteConnection, GLib.Variant]: ...
    def add_connection_async(self, connection: Connection, save_to_disk: bool, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def add_connection_finish(self, result: Gio.AsyncResult) -> RemoteConnection: ...
    def check_connectivity(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> ConnectivityState: ...
    def check_connectivity_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def check_connectivity_finish(self, result: Gio.AsyncResult) -> ConnectivityState: ...
    def checkpoint_adjust_rollback_timeout(self, checkpoint_path: str, add_timeout: int, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def checkpoint_adjust_rollback_timeout_finish(self, result: Gio.AsyncResult) -> bool: ...
    def checkpoint_create(self, devices: typing.Sequence[Device], rollback_timeout: int, flags: CheckpointCreateFlags, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def checkpoint_create_finish(self, result: Gio.AsyncResult) -> Checkpoint: ...
    def checkpoint_destroy(self, checkpoint_path: str, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def checkpoint_destroy_finish(self, result: Gio.AsyncResult) -> bool: ...
    def checkpoint_rollback(self, checkpoint_path: str, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    ...
    def dbus_call(self, object_path: str, interface_name: str, method_name: str, parameters: typing.Optional[GLib.Variant], reply_type: typing.Optional[GLib.VariantType], timeout_msec: int, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def dbus_call_finish(self, result: Gio.AsyncResult) -> GLib.Variant: ...
    def dbus_set_property(self, object_path: str, interface_name: str, property_name: str, value: GLib.Variant, timeout_msec: int, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def dbus_set_property_finish(self, result: Gio.AsyncResult) -> bool: ...
    def deactivate_connection(self, active: ActiveConnection, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def deactivate_connection_async(self, active: ActiveConnection, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    ...
    def get_logging(self) -> typing.Tuple[bool, str, str]: ...
    ...
    def get_permission_result(self, permission: ClientPermission) -> ClientPermissionResult: ...
    ...
    def load_connections(self, filenames: typing.Sequence[str], cancellable: typing.Optional[Gio.Cancellable] = None) -> typing.Tuple[bool, str]: ...
    def load_connections_async(self, filenames: typing.Sequence[str], cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def load_connections_finish(self, result: Gio.AsyncResult) -> typing.Tuple[bool, list[str]]: ...
    def networking_get_enabled(self) -> bool: ...
    def networking_set_enabled(self, enabled: bool) -> bool: ...
    @classmethod
    def new(cls, cancellable: typing.Optional[Gio.Cancellable] = None) -> Client: ...
    @staticmethod
    def new_async(cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    @classmethod
    def new_finish(cls, result: Gio.AsyncResult) -> Client: ...
    def reload(self, flags: ManagerReloadFlags, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def reload_connections(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def reload_connections_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def reload_connections_finish(self, result: Gio.AsyncResult) -> bool: ...
    def reload_finish(self, result: Gio.AsyncResult) -> bool: ...
    def save_hostname(self, hostname: typing.Optional[str] = None, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def save_hostname_async(self, hostname: typing.Optional[str] = None, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def save_hostname_finish(self, result: Gio.AsyncResult) -> bool: ...
    def set_logging(self, level: typing.Optional[str] = None, domains: typing.Optional[str] = None) -> bool: ...
    def wait_shutdown(self, integrate_maincontext: bool, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    @staticmethod
...
class Connection(GObject.GInterface):
    ...
    def clear_secrets_with_flags(self, func: typing.Optional[typing.Callable[..., bool]] = None, *user_data: typing.Any) -> None: ...
    def clear_settings(self) -> None: ...
    def compare(self, b: Connection, flags: SettingCompareFlags) -> bool: ...
    def dump(self) -> None: ...
    def for_each_setting_value(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def get_connection_type(self) -> str: ...
    def get_id(self) -> str: ...
    def get_interface_name(self) -> str: ...
    def get_path(self) -> str: ...
    def get_setting(self, setting_type: typing.Type[typing.Any]) -> Setting: ...
    ...
    def get_settings(self) -> typing.Optional[list[Setting]]: ...
    def get_uuid(self) -> str: ...
    def get_virtual_device_description(self) -> str: ...
    def is_type(self, type: str) -> bool: ...
    def is_virtual(self) -> bool: ...
    def need_secrets(self) -> typing.Tuple[typing.Optional[str], list[str]]: ...
    def normalize(self, parameters: typing.Optional[dict[str, None]] = None) -> typing.Tuple[bool, bool]: ...
    def remove_setting(self, setting_type: typing.Type[typing.Any]) -> None: ...
...
class ConnectionInterface(GObject.GPointer):
    ...
    secrets_updated: typing.Callable[[Connection, str], None] = ...
    secrets_cleared: typing.Callable[[Connection], None] = ...
    changed: typing.Callable[[Connection], None] = ...
...
class Device(Object):
    ...
    class Props:
        ...
        client: typing.Optional[Client]
    props: Props = ...
    def __init__(self, autoconnect: bool = ...) -> None: ...
    def connection_compatible(self, connection: Connection) -> bool: ...
    def connection_valid(self, connection: Connection) -> bool: ...
    def delete(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def delete_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def delete_finish(self, result: Gio.AsyncResult) -> bool: ...
    @staticmethod
    def disambiguate_names(devices: typing.Sequence[Device]) -> list[str]: ...
    def disconnect(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def disconnect_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def disconnect_finish(self, result: Gio.AsyncResult) -> bool: ...
    def filter_connections(self, connections: typing.Sequence[Connection]) -> list[Connection]: ...
    def get_active_connection(self) -> ActiveConnection: ...
    def get_applied_connection(self, flags: int, cancellable: typing.Optional[Gio.Cancellable] = None) -> typing.Tuple[Connection, int]: ...
    def get_applied_connection_async(self, flags: int, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def get_applied_connection_finish(self, result: Gio.AsyncResult) -> typing.Tuple[Connection, int]: ...
    ...
    def get_setting_type(self) -> typing.Type[typing.Any]: ...
    ...
    def reapply(self, connection: typing.Optional[Connection], version_id: int, flags: int, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def reapply_async(self, connection: typing.Optional[Connection], version_id: int, flags: int, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
...
class DeviceIpvlan(Device):
    ...
    ::
        ...
        DeviceIpvlan(**properties)

    Object NMDeviceIpvlan

    Properties from NMDeviceIpvlan:
      parent -> NMDevice: 
...
class DeviceIpvlanClass(GObject.GPointer): ...
...
class DeviceWifi(Device):
    ...
    def get_mode(self) -> 80211Mode: ...
    def get_permanent_hw_address(self) -> str: ...
    def request_scan(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def request_scan_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def request_scan_finish(self, result: Gio.AsyncResult) -> bool: ...
    def request_scan_options(self, options: GLib.Variant, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def request_scan_options_async(self, options: GLib.Variant, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
...
class DeviceWifiP2P(Device):
    ...
    def start_find(self, options: typing.Optional[GLib.Variant] = None, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def start_find_finish(self, result: Gio.AsyncResult) -> bool: ...
    def stop_find(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
...
class IPAddress(GObject.GBoxed):
    ...
    def set_attribute(self, name: str, value: typing.Optional[GLib.Variant] = None) -> None: ...
...
class IPRoute(GObject.GBoxed):
    ...
    """
    @staticmethod
    def attribute_validate(name: str, value: GLib.Variant, family: int) -> typing.Tuple[bool, bool]: ...
    ...
    @classmethod
    def new(cls, family: int, dest: str, prefix: int, next_hop: typing.Optional[str], metric: int) -> IPRoute: ...
    @classmethod
    ...
    def set_next_hop(self, next_hop: typing.Optional[str] = None) -> None: ...
    def set_prefix(self, prefix: int) -> None: ...
    def unref(self) -> None: ...
...
class IPRoutingRule(GObject.GBoxed):
    ...
    """
    def cmp(self, other: typing.Optional[IPRoutingRule] = None) -> int: ...
    @staticmethod
    def from_string(str: str, to_string_flags: IPRoutingRuleAsStringFlags, extra_args: typing.Optional[dict[None, None]] = None) -> IPRoutingRule: ...
    ...
    def get_tos(self) -> int: ...
    def get_uid_range(self) -> typing.Tuple[bool, int, int]: ...
    def is_sealed(self) -> bool: ...
    @classmethod
    ...
    def set_from(self, from_: typing.Optional[str], len: int) -> None: ...
    def set_fwmark(self, fwmark: int, fwmask: int) -> None: ...
    def set_iifname(self, iifname: typing.Optional[str] = None) -> None: ...
    def set_invert(self, invert: bool) -> None: ...
    def set_ipproto(self, ipproto: int) -> None: ...
    def set_oifname(self, oifname: typing.Optional[str] = None) -> None: ...
    ...
    def set_to(self, to: typing.Optional[str], len: int) -> None: ...
    def set_tos(self, tos: int) -> None: ...
    def set_uid_range(self, uid_range_start: int, uid_range_end: int) -> None: ...
    def to_string(self, to_string_flags: IPRoutingRuleAsStringFlags, extra_args: typing.Optional[dict[None, None]] = None) -> str: ...
    def unref(self) -> None: ...
...
class KeyfileHandlerData(GObject.GPointer):
    ...
    def get_context(self) -> typing.Tuple[str, str, Setting, str]: ...
    def warn_get(self) -> typing.Tuple[str, KeyfileWarnSeverity]: ...
...
class LldpNeighbor(GObject.GBoxed):
    ...
    def get_attr_string_value(self, name: str) -> typing.Tuple[bool, str]: ...
    def get_attr_type(self, name: str) -> GLib.VariantType: ...
    def get_attr_uint_value(self, name: str) -> typing.Tuple[bool, int]: ...
...
class Range(GObject.GBoxed):
    ...
    def get_range(self) -> typing.Tuple[bool, int, int]: ...
    @classmethod
...
class RemoteConnection(Object, Connection):
    ...
    class Props:
        ...
        path: str
    props: Props = ...
    def commit_changes(self, save_to_disk: bool, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def commit_changes_async(self, save_to_disk: bool, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    ...
    def get_secrets(self, setting_name: str, cancellable: typing.Optional[Gio.Cancellable] = None) -> GLib.Variant: ...
    def get_secrets_async(self, setting_name: str, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def get_secrets_finish(self, result: Gio.AsyncResult) -> GLib.Variant: ...
    def get_unsaved(self) -> bool: ...
    def get_version_id(self) -> int: ...
    def get_visible(self) -> bool: ...
    def save(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def save_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def save_finish(self, result: Gio.AsyncResult) -> bool: ...
    def update2(self, settings: typing.Optional[GLib.Variant], flags: SettingsUpdate2Flags, args: typing.Optional[GLib.Variant] = None, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
...
class SecretAgentOld(GObject.Object, Gio.AsyncInitable, Gio.Initable):
    ...
    def __init__(self, auto_register: bool = ...,
                 ...
                 dbus_connection: Gio.DBusConnection = ...,
                 identifier: str = ...) -> None: ...
    def delete_secrets(self, connection: Connection, callback: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def destroy(self) -> None: ...
    def do_cancel_get_secrets(self, connection_path: str, setting_name: str) -> None: ...
    def do_delete_secrets(self, connection: Connection, connection_path: str, callback: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def do_get_secrets(self, connection: Connection, connection_path: str, setting_name: str, hints: typing.Sequence[str], flags: SecretAgentGetSecretsFlags, callback: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def do_save_secrets(self, connection: Connection, connection_path: str, callback: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    ...
    def get_secrets(self, connection: Connection, setting_name: str, hints: typing.Sequence[str], flags: SecretAgentGetSecretsFlags, callback: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def register(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def register_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
    def register_finish(self, result: Gio.AsyncResult) -> bool: ...
    def save_secrets(self, connection: Connection, callback: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def unregister(self, cancellable: typing.Optional[Gio.Cancellable] = None) -> bool: ...
    def unregister_async(self, cancellable: typing.Optional[Gio.Cancellable] = None, callback: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> None: ...
...
class SecretAgentOldClass(GObject.GPointer):
    ...
    get_secrets: typing.Callable[..., None] = ...
    cancel_get_secrets: typing.Callable[[SecretAgentOld, str, str], None] = ...
    save_secrets: typing.Callable[..., None] = ...
    delete_secrets: typing.Callable[..., None] = ...
    padding: list[None] = ...
...
class Setting(GObject.Object):
    ...
    def diff(self, b: Setting, flags: SettingCompareFlags, invert_results: bool) -> typing.Tuple[bool, dict[str, int]]: ...
    def duplicate(self) -> Setting: ...
    def enumerate_values(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def get_dbus_property_type(self, property_name: str) -> GLib.VariantType: ...
    @staticmethod
    def get_enum_property_type(setting_type: typing.Type[typing.Any], property_name: str) -> typing.Type[typing.Any]: ...
    def get_name(self) -> str: ...
    def get_secret_flags(self, secret_name: str, out_flags: SettingSecretFlags) -> bool: ...
    @staticmethod
    def lookup_type(name: str) -> typing.Type[typing.Any]: ...
    def option_clear_by_name(self, predicate: typing.Optional[typing.Callable[[str], bool]] = None) -> None: ...
    def option_get(self, opt_name: str) -> GLib.Variant: ...
    def option_get_all_names(self) -> typing.Optional[list[str]]: ...
    def option_get_boolean(self, opt_name: str) -> typing.Tuple[bool, bool]: ...
    def option_get_uint32(self, opt_name: str) -> typing.Tuple[bool, int]: ...
    def option_set(self, opt_name: str, variant: typing.Optional[GLib.Variant] = None) -> None: ...
    ...
    def verify(self, connection: typing.Optional[Connection] = None) -> bool: ...
    def verify_secrets(self, connection: typing.Optional[Connection] = None) -> bool: ...
...
class Setting8021x(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, altsubject_matches: typing.Sequence[str] = ...,
                 anonymous_identity: str = ...,
                 auth_timeout: int = ...,
                 ca_cert: GLib.Bytes = ...,
                 ca_cert_password: str = ...,
                 ...
                 phase1_peaplabel: str = ...,
                 phase1_peapver: str = ...,
                 phase2_altsubject_matches: typing.Sequence[str] = ...,
                 phase2_auth: str = ...,
                 phase2_autheap: str = ...,
                 phase2_ca_cert: GLib.Bytes = ...,
                 phase2_ca_cert_password: str = ...,
    ...
    def remove_phase2_altsubject_match_by_value(self, phase2_altsubject_match: str) -> bool: ...
    def set_ca_cert(self, value: str, scheme: Setting8021xCKScheme, out_format: Setting8021xCKFormat) -> bool: ...
    def set_client_cert(self, value: str, scheme: Setting8021xCKScheme, out_format: Setting8021xCKFormat) -> bool: ...
    def set_phase2_ca_cert(self, value: str, scheme: Setting8021xCKScheme, out_format: Setting8021xCKFormat) -> bool: ...
...
class SettingAdsl(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, encapsulation: str = ...,
                 password: str = ...,
                 password_flags: SettingSecretFlags = ...,
                 protocol: str = ...,
                 username: str = ...,
...
class SettingBond(Setting):
    ...
    def get_option(self, idx: int) -> typing.Tuple[bool, str, str]: ...
    ...
    def get_valid_options(self) -> typing.Optional[list[str]]: ...
    @classmethod
    def new(cls) -> SettingBond: ...
    def remove_option(self, name: str) -> bool: ...
    @staticmethod
    def validate_option(name: str, value: typing.Optional[str] = None) -> bool: ...
...
class SettingBridge(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, ageing_time: int = ...,
                 forward_delay: int = ...,
                 group_address: str = ...,
                 group_forward_mask: int = ...,
                 hello_time: int = ...,
                 ...
                 vlan_protocol: str = ...,
                 vlan_stats_enabled: bool = ...,
                 vlans: typing.Sequence[BridgeVlan] = ...) -> None: ...
...
class SettingBridgePort(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, hairpin_mode: bool = ...,
                 path_cost: int = ...,
                 priority: int = ...,
                 vlans: typing.Sequence[BridgeVlan] = ...) -> None: ...
    def add_vlan(self, vlan: BridgeVlan) -> None: ...
...
class SettingConnection(Setting):
    ...
    Properties from NMSettingConnection:
      ...
      ip-ping-timeout -> guint: 
    
      ip-ping-addresses -> GStrv: 
    
      ip-ping-addresses-require-all -> gint: 
    ...
    class Props:
        ...
        id: str
        interface_name: str
        ip_ping_addresses: list[str]
        ip_ping_addresses_require_all: int
        ip_ping_timeout: int
        lldp: int
        llmnr: int
        master: str
        ...
        name: str
    props: Props = ...
    def __init__(self, auth_retries: int = ...,
                 autoconnect: bool = ...,
                 autoconnect_ports: int = ...,
                 autoconnect_priority: int = ...,
                 autoconnect_retries: int = ...,
                 ...
                 id: str = ...,
                 interface_name: str = ...,
                 ip_ping_addresses: typing.Sequence[str] = ...,
                 ip_ping_addresses_require_all: int = ...,
                 ip_ping_timeout: int = ...,
                 lldp: int = ...,
                 llmnr: int = ...,
                 ...
                 port_type: str = ...,
                 read_only: bool = ...,
                 secondaries: typing.Sequence[str] = ...,
                 slave_type: str = ...,
                 stable_id: str = ...,
                 timestamp: int = ...,
                 type: str = ...,
                 ...
                 wait_device_timeout: int = ...,
                 zone: str = ...) -> None: ...
    def add_ip_ping_address(self, address: str) -> bool: ...
    def add_permission(self, ptype: str, pitem: str, detail: typing.Optional[str] = None) -> bool: ...
    ...
    def get_id(self) -> str: ...
    def get_interface_name(self) -> str: ...
    def get_ip_ping_address(self, idx: int) -> str: ...
    ...
    def get_permission(self, idx: int, out_ptype: str, out_pitem: str, out_detail: str) -> bool: ...
    ...
    def remove_ip_ping_address(self, idx: int) -> None: ...
    def remove_ip_ping_address_by_value(self, address: str) -> bool: ...
    def remove_permission(self, idx: int) -> None: ...
    def remove_permission_by_value(self, ptype: str, pitem: str, detail: typing.Optional[str] = None) -> bool: ...
...
class SettingDcb(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, app_fcoe_flags: SettingDcbFlags = ...,
                 app_fcoe_mode: str = ...,
                 app_fcoe_priority: int = ...,
                 app_fip_flags: SettingDcbFlags = ...,
                 app_fip_priority: int = ...,
                 app_iscsi_flags: SettingDcbFlags = ...,
                 app_iscsi_priority: int = ...,
                 priority_bandwidth: typing.Sequence[int] = ...,
                 priority_flow_control: typing.Sequence[bool] = ...,
                 priority_flow_control_flags: SettingDcbFlags = ...,
                 priority_group_bandwidth: typing.Sequence[int] = ...,
                 priority_group_flags: SettingDcbFlags = ...,
                 priority_group_id: typing.Sequence[int] = ...,
                 priority_strict_bandwidth: typing.Sequence[bool] = ...,
                 priority_traffic_class: typing.Sequence[int] = ...) -> None: ...
    ...
    def set_priority_bandwidth(self, user_priority: int, bandwidth_percent: int) -> None: ...
    def set_priority_flow_control(self, user_priority: int, enabled: bool) -> None: ...
    def set_priority_group_bandwidth(self, group_id: int, bandwidth_percent: int) -> None: ...
...
class SettingEthtool(Setting):
    ...
    def get_optnames(self) -> typing.Tuple[list[str], int]: ...
    @classmethod
...
class SettingGeneric(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, device_handler: str = ...) -> None: ...
...
class SettingGsm(Setting):
    ...
    Properties from NMSettingGsm:
      ...
      initial-eps-bearer-username -> gchararray: 
    
      initial-eps-bearer-password -> gchararray: 
    
      initial-eps-bearer-password-flags -> NMSettingSecretFlags: 
    
      initial-eps-bearer-noauth -> gboolean: 
    
      initial-eps-bearer-refuse-eap -> gboolean: 
    
      initial-eps-bearer-refuse-pap -> gboolean: 
    
      initial-eps-bearer-refuse-chap -> gboolean: 
    
      initial-eps-bearer-refuse-mschap -> gboolean: 
    
      initial-eps-bearer-refuse-mschapv2 -> gboolean: 
    ...
    class Props:
        ...
        initial_eps_bearer_noauth: bool
        initial_eps_bearer_password: str
        initial_eps_bearer_password_flags: SettingSecretFlags
        initial_eps_bearer_refuse_chap: bool
        initial_eps_bearer_refuse_eap: bool
        initial_eps_bearer_refuse_mschap: bool
        initial_eps_bearer_refuse_mschapv2: bool
        initial_eps_bearer_refuse_pap: bool
        initial_eps_bearer_username: str
        mtu: int
        network_id: str
        number: str
        password: str
...
class SettingHostname(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, from_dhcp: Ternary = ...,
                 from_dns_lookup: Ternary = ...,
                 only_from_default: Ternary = ...,
                 priority: int = ...) -> None: ...
...
class SettingHsr(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, multicast_spec: int = ...,
                 port1: str = ...,
                 port2: str = ...,
                 prp: bool = ...) -> None: ...
    def get_multicast_spec(self) -> int: ...
...
class SettingIP4Config(SettingIPConfig):
    ...
    Properties from NMSettingIPConfig:
      ...
      shared-dhcp-range -> gchararray: 
    
      shared-dhcp-lease-time -> gint: 
    ...
    class Props:
        ...
        routed_dns: int
        routes: list[IPRoute]
        shared_dhcp_lease_time: int
        shared_dhcp_range: str
        name: str
    props: Props = ...
    def __init__(self, dhcp_client_id: str = ...,
                 dhcp_fqdn: str = ...,
                 dhcp_ipv6_only_preferred: int = ...,
                 dhcp_vendor_class_identifier: str = ...,
                 link_local: int = ...,
                 addresses: typing.Sequence[IPAddress] = ...,
                 auto_route_ext_gw: Ternary = ...,
                 dad_timeout: int = ...,
                 dhcp_dscp: str = ...,
                 dhcp_hostname: str = ...,
                 dhcp_hostname_flags: int = ...,
                 dhcp_iaid: str = ...,
                 dhcp_reject_servers: typing.Sequence[str] = ...,
                 dhcp_send_hostname: bool = ...,
                 dhcp_send_hostname_v2: int = ...,
                 dhcp_send_release: Ternary = ...,
                 dhcp_timeout: int = ...,
                 dns: typing.Sequence[str] = ...,
                 dns_options: typing.Sequence[str] = ...,
                 dns_priority: int = ...,
                 dns_search: typing.Sequence[str] = ...,
                 gateway: str = ...,
                 ignore_auto_dns: bool = ...,
                 ignore_auto_routes: bool = ...,
                 may_fail: bool = ...,
                 ...
                 route_table: int = ...,
                 routed_dns: int = ...,
                 routes: typing.Sequence[IPRoute] = ...,
                 shared_dhcp_lease_time: int = ...,
                 shared_dhcp_range: str = ...) -> None: ...
...
class SettingIP6Config(SettingIPConfig):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, addr_gen_mode: int = ...,
                 dhcp_duid: str = ...,
                 dhcp_pd_hint: str = ...,
                 ip6_privacy: SettingIP6ConfigPrivacy = ...,
                 mtu: int = ...,
...
class SettingIPConfig(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, addresses: typing.Sequence[IPAddress] = ...,
                 auto_route_ext_gw: Ternary = ...,
                 dad_timeout: int = ...,
                 dhcp_dscp: str = ...,
                 dhcp_hostname: str = ...,
...
class SettingIPTunnel(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, encapsulation_limit: int = ...,
                 flags: int = ...,
                 flow_label: int = ...,
                 fwmark: int = ...,
                 input_key: str = ...,
...
class SettingIpvlan(Setting):
    ...
    ::
        ...
        SettingIpvlan(**properties)
        new() -> NM.Setting

    Object NMSettingIpvlan

    Properties from NMSettingIpvlan:
      parent -> gchararray: 
    ...
    def get_vepa(self) -> bool: ...
    @classmethod
    def new(cls) -> SettingIpvlan: ...
    

class SettingIpvlanClass(GObject.GPointer): ...
...
class SettingLink(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, gro_max_size: int = ...,
                 gso_max_segments: int = ...,
                 gso_max_size: int = ...,
                 tx_queue_length: int = ...) -> None: ...
...
class SettingMatch(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, driver: typing.Sequence[str] = ...,
                 interface_name: typing.Sequence[str] = ...,
                 kernel_command_line: typing.Sequence[str] = ...,
...
class SettingOvsBridge(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, datapath_type: str = ...,
                 fail_mode: str = ...,
                 mcast_snooping_enable: bool = ...,
                 rstp_enable: bool = ...,
                 stp_enable: bool = ...) -> None: ...
...
class SettingOvsExternalIDs(Setting):
    ...
    @staticmethod
    def check_key(key: typing.Optional[str] = None) -> bool: ...
    @staticmethod
    def check_val(val: typing.Optional[str] = None) -> bool: ...
    def get_data(self, key: str) -> str: ...
    def get_data_keys(self) -> list[str]: ...
    @classmethod
    def new(cls) -> SettingOvsExternalIDs: ...
    def set_data(self, key: str, val: typing.Optional[str] = None) -> None: ...
...
class SettingOvsInterface(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, ofport_request: int = ...,
                 type: str = ...) -> None: ...
...
class SettingOvsPort(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, bond_downdelay: int = ...,
                 bond_mode: str = ...,
                 bond_updelay: int = ...,
                 lacp: str = ...,
                 tag: int = ...,
                 trunks: typing.Sequence[Range] = ...,
                 vlan_mode: str = ...) -> None: ...
...
class SettingProxy(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, browser_only: bool = ...,
                 method: int = ...,
                 pac_script: str = ...,
                 pac_url: str = ...) -> None: ...
...
class SettingSriov(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, autoprobe_drivers: Ternary = ...,
                 eswitch_encap_mode: int = ...,
                 eswitch_inline_mode: int = ...,
                 eswitch_mode: int = ...,
                 total_vfs: int = ...,
                 vfs: typing.Sequence[SriovVF] = ...) -> None: ...
...
class SettingTCConfig(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, qdiscs: typing.Sequence[TCQdisc] = ...,
                 tfilters: typing.Sequence[TCTfilter] = ...) -> None: ...
...
class SettingTeam(Setting):
    ...
    def __init__(self, config: str = ...,
                 link_watchers: typing.Sequence[TeamLinkWatcher] = ...,
                 mcast_rejoin_count: int = ...,
                 mcast_rejoin_interval: int = ...,
                 notify_peers_count: int = ...,
                 notify_peers_interval: int = ...,
                 ...
                 runner_tx_balancer: str = ...,
                 runner_tx_balancer_interval: int = ...,
                 runner_tx_hash: typing.Sequence[str] = ...) -> None: ...
...
class SettingUser(Setting):
    ...
    def set_data(self, key: str, val: typing.Optional[str] = None) -> bool: ...
...
class SettingVlan(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, egress_priority_map: typing.Sequence[str] = ...,
                 flags: VlanFlags = ...,
                 id: int = ...,
                 ingress_priority_map: typing.Sequence[str] = ...,
                 parent: str = ...,
                 protocol: str = ...) -> None: ...
    ...
    def get_parent(self) -> str: ...
    def get_priority(self, map: VlanPriorityMap, idx: int) -> typing.Tuple[bool, int, int]: ...
    def get_protocol(self) -> str: ...
    @classmethod
...
class SettingVpn(Setting):
    ...
    def __init__(self, data: dict[str, str] = ...,
                 ...
                 timeout: int = ...,
                 user_name: str = ...) -> None: ...
    def add_data_item(self, key: str, item: typing.Optional[str] = None) -> None: ...
    def add_secret(self, key: str, secret: typing.Optional[str] = None) -> None: ...
    def foreach_data_item(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def foreach_secret(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def get_data_item(self, key: str) -> str: ...
    def get_data_keys(self) -> typing.Optional[list[str]]: ...
    def get_num_data_items(self) -> int: ...
    def get_num_secrets(self) -> int: ...
    def get_persistent(self) -> bool: ...
    def get_secret(self, key: str) -> str: ...
    def get_secret_keys(self) -> typing.Optional[list[str]]: ...
...
class SettingWireGuard(Setting):
    ...
    def __init__(self, fwmark: int = ...,
                 ...
                 peer_routes: bool = ...,
                 private_key: str = ...,
                 private_key_flags: SettingSecretFlags = ...) -> None: ...
    ...
    def get_peer_by_public_key(self, public_key: str) -> typing.Tuple[typing.Optional[WireGuardPeer], int]: ...
...
class SettingWired(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, accept_all_mac_addresses: Ternary = ...,
                 auto_negotiate: bool = ...,
                 cloned_mac_address: str = ...,
                 duplex: str = ...,
                 generate_mac_address_mask: str = ...,
                 mac_address: str = ...,
                 mac_address_blacklist: typing.Sequence[str] = ...,
                 mac_address_denylist: typing.Sequence[str] = ...,
                 mtu: int = ...,
                 port: str = ...,
                 s390_nettype: str = ...,
                 s390_options: dict[str, str] = ...,
                 s390_subchannels: typing.Sequence[str] = ...,
                 speed: int = ...,
                 wake_on_lan: int = ...,
                 wake_on_lan_password: str = ...) -> None: ...
    ...
    def get_s390_option(self, idx: int) -> typing.Tuple[bool, str, str]: ...
...
class SettingWireless(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, ap_isolation: Ternary = ...,
                 band: str = ...,
                 bssid: str = ...,
                 channel: int = ...,
                 channel_width: int = ...,
                 ...
                 powersave: int = ...,
                 rate: int = ...,
                 seen_bssids: typing.Sequence[str] = ...,
                 ssid: GLib.Bytes = ...,
                 tx_power: int = ...,
                 wake_on_wlan: int = ...) -> None: ...
    def add_mac_blacklist_item(self, mac: str) -> bool: ...
    def add_mac_denylist_item(self, mac: str) -> bool: ...
    def add_seen_bssid(self, bssid: str) -> bool: ...
    def ap_security_compatible(self, s_wireless_sec: SettingWirelessSecurity, ap_flags: 80211ApFlags, ap_wpa: 80211ApSecurityFlags, ap_rsn: 80211ApSecurityFlags, ap_mode: 80211Mode) -> bool: ...
    def clear_mac_blacklist_items(self) -> None: ...
    def clear_mac_denylist_items(self) -> None: ...
...
class SettingWirelessSecurity(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, auth_alg: str = ...,
                 fils: int = ...,
                 ...
                 leap_password_flags: SettingSecretFlags = ...,
                 leap_username: str = ...,
                 pairwise: typing.Sequence[str] = ...,
                 pmf: int = ...,
                 proto: typing.Sequence[str] = ...,
                 psk: str = ...,
                 psk_flags: SettingSecretFlags = ...,
                 wep_key_flags: SettingSecretFlags = ...,
                 wep_key_type: WepKeyType = ...,
...
class SriovVF(GObject.GBoxed):
    ...
    @staticmethod
    def attribute_validate(name: str, value: GLib.Variant) -> typing.Tuple[bool, bool]: ...
...
class TeamLinkWatcher(GObject.GBoxed):
    ...
    @classmethod
    def new_arp_ping(cls, init_wait: int, interval: int, missed_max: int, target_host: str, source_host: str, flags: TeamLinkWatcherArpPingFlags) -> TeamLinkWatcher: ...
    @classmethod
    def new_arp_ping2(cls, init_wait: int, interval: int, missed_max: int, vlanid: int, target_host: str, source_host: str, flags: TeamLinkWatcherArpPingFlags) -> TeamLinkWatcher: ...
    @classmethod
...
class VpnEditorInterface(GObject.GPointer):
    ...
    get_widget: typing.Callable[[VpnEditor], GObject.Object] = ...
    placeholder: typing.Callable[[], None] = ...
    update_connection: typing.Callable[[VpnEditor, Connection], bool] = ...
    changed: typing.Callable[[VpnEditor], None] = ...
...
class VpnEditorPlugin(GObject.GInterface):
    ...
    def get_vt(self, vt_size: int) -> typing.Tuple[int, VpnEditorPluginVT]: ...
    def import_(self, path: str) -> Connection: ...
    @staticmethod
    def load(plugin_name: str, check_service: str) -> VpnEditorPlugin: ...
    @staticmethod
    def load_from_file(plugin_name: str, check_service: str, check_owner: int, check_file: typing.Callable[..., bool], *user_data: typing.Any) -> VpnEditorPlugin: ...
    def set_plugin_info(self, plugin_info: typing.Optional[VpnPluginInfo] = None) -> None: ...
...
class VpnEditorPluginInterface(GObject.GPointer):
    ...
    """
    g_iface: GObject.TypeInterface = ...
    get_editor: typing.Callable[[VpnEditorPlugin, Connection], VpnEditor] = ...
    get_capabilities: typing.Callable[[VpnEditorPlugin], VpnEditorPluginCapability] = ...
    import_from_file: None = ...
    export_to_file: typing.Callable[[VpnEditorPlugin, str, Connection], bool] = ...
    get_suggested_filename: typing.Callable[[VpnEditorPlugin, Connection], str] = ...
    notify_plugin_info_set: typing.Callable[[VpnEditorPlugin, VpnPluginInfo], None] = ...
    get_vt: typing.Callable[[VpnEditorPlugin, int], VpnEditorPluginVT] = ...
...
class VpnPluginInfo(GObject.Object, Gio.Initable):
    ...
    @staticmethod
    def list_find_by_filename(list: list[VpnPluginInfo], filename: str) -> VpnPluginInfo: ...
    @staticmethod
    def list_find_by_name(list: list[VpnPluginInfo], name: str) -> VpnPluginInfo: ...
    @staticmethod
    def list_find_by_service(list: list[VpnPluginInfo], service: str) -> VpnPluginInfo: ...
    @staticmethod
    def list_find_service_type(list: list[VpnPluginInfo], name: str) -> str: ...
    @staticmethod
    def list_get_service_types(list: list[VpnPluginInfo], only_existing: bool, with_abbreviations: bool) -> list[str]: ...
    @staticmethod
    ...
    @classmethod
    def new_search_file(cls, name: typing.Optional[str] = None, service: typing.Optional[str] = None) -> typing.Optional[VpnPluginInfo]: ...
    @classmethod
    def new_with_data(cls, filename: str, keyfile: GLib.KeyFile) -> VpnPluginInfo: ...
    def set_editor_plugin(self, plugin: typing.Optional[VpnEditorPlugin] = None) -> None: ...
...
class VpnPluginOld(GObject.Object, Gio.Initable):
    ...
    def __init__(self, service_name: str = ...,
                 state: VpnServiceState = ...) -> None: ...
    def disconnect(self) -> bool: ...
    def do_config(self, config: GLib.Variant) -> None: ...
    def do_connect(self, connection: Connection) -> bool: ...
    def do_connect_interactive(self, connection: Connection, details: GLib.Variant) -> bool: ...
    ...
    @staticmethod
    def get_secret_flags(data: dict[None, None], secret_name: str) -> typing.Tuple[bool, SettingSecretFlags]: ...
    def get_state(self) -> VpnServiceState: ...
    @staticmethod
    def read_vpn_details(fd: int) -> typing.Tuple[bool, dict[None, None], dict[None, None]]: ...
...
class VpnPluginOldClass(GObject.GPointer):
    ...
    """
    parent: GObject.ObjectClass = ...
    state_changed: typing.Callable[[VpnPluginOld, VpnServiceState], None] = ...
    ip4_config: typing.Callable[[VpnPluginOld, GLib.Variant], None] = ...
    login_banner: typing.Callable[[VpnPluginOld, str], None] = ...
    failure: typing.Callable[[VpnPluginOld, VpnPluginFailure], None] = ...
    quit: typing.Callable[[VpnPluginOld], None] = ...
    config: typing.Callable[[VpnPluginOld, GLib.Variant], None] = ...
    ip6_config: typing.Callable[[VpnPluginOld, GLib.Variant], None] = ...
    connect: typing.Callable[[VpnPluginOld, Connection], bool] = ...
    need_secrets: typing.Callable[[VpnPluginOld, Connection, str], bool] = ...
    disconnect: typing.Callable[[VpnPluginOld], bool] = ...
    new_secrets: typing.Callable[[VpnPluginOld, Connection], bool] = ...
    connect_interactive: typing.Callable[[VpnPluginOld, Connection, GLib.Variant], bool] = ...
    padding: list[None] = ...
...
class VpnServicePluginClass(GObject.GPointer):
    ...
    """
    parent: GObject.ObjectClass = ...
    state_changed: typing.Callable[[VpnServicePlugin, VpnServiceState], None] = ...
    ip4_config: typing.Callable[[VpnServicePlugin, GLib.Variant], None] = ...
    login_banner: typing.Callable[[VpnServicePlugin, str], None] = ...
    failure: typing.Callable[[VpnServicePlugin, VpnPluginFailure], None] = ...
    quit: typing.Callable[[VpnServicePlugin], None] = ...
    config: typing.Callable[[VpnServicePlugin, GLib.Variant], None] = ...
    ip6_config: typing.Callable[[VpnServicePlugin, GLib.Variant], None] = ...
    connect: typing.Callable[[VpnServicePlugin, Connection], bool] = ...
    need_secrets: typing.Callable[[VpnServicePlugin, Connection, str], bool] = ...
    disconnect: typing.Callable[[VpnServicePlugin], bool] = ...
    new_secrets: typing.Callable[[VpnServicePlugin, Connection], bool] = ...
    connect_interactive: typing.Callable[[VpnServicePlugin, Connection, GLib.Variant], bool] = ...
    padding: list[None] = ...
...
class WireGuardPeer(GObject.GBoxed):
    ...
    def cmp(self, b: typing.Optional[WireGuardPeer], compare_flags: SettingCompareFlags) -> int: ...
    def get_allowed_ip(self, idx: int, out_is_valid: typing.Optional[bool] = None) -> typing.Optional[str]: ...
    ...
    def set_preshared_key(self, preshared_key: typing.Optional[str], accept_invalid: bool) -> bool: ...
    def set_preshared_key_flags(self, preshared_key_flags: SettingSecretFlags) -> None: ...
    def set_public_key(self, public_key: typing.Optional[str], accept_invalid: bool) -> bool: ...
    def unref(self) -> None: ...
    

class ActivationStateFlags(GObject.GFlags):
...
class BluetoothCapabilities(GObject.GFlags):
    DUN = 1
    NAP = 2
    NONE = 0

class CheckpointCreateFlags(GObject.GFlags):
    ALLOW_OVERLAPPING = 8
...
class ClientInstanceFlags(GObject.GFlags):
    INITIALIZED_BAD = 4
    INITIALIZED_GOOD = 2
    NONE = 0
    NO_AUTO_FETCH_PERMISSIONS = 1

class ConnectionSerializationFlags(GObject.GFlags):
    ALL = 0
    NO_SECRETS = 1
    ONLY_SECRETS = 2
    WITH_NON_SECRET = 1
...
class DeviceCapabilities(GObject.GFlags):
    CARRIER_DETECT = 2
    IS_SOFTWARE = 4
    NM_SUPPORTED = 1
    NONE = 0
...
class DeviceInterfaceFlags(GObject.GFlags):
    CARRIER = 65536
...
class DeviceModemCapabilities(GObject.GFlags):
    CDMA_EVDO = 2
    GSM_UMTS = 4
    LTE = 8
    NONE = 0
...
class DeviceReapplyFlags(GObject.GFlags):
    NONE = 0
    PRESERVE_EXTERNAL_IP = 1

class DeviceWifiCapabilities(GObject.GFlags):
    ADHOC = 128
    AP = 64
    CIPHER_CCMP = 8
    CIPHER_TKIP = 4
...
class DhcpHostnameFlags(GObject.GFlags):
    FQDN_CLEAR_FLAGS = 8
    FQDN_ENCODED = 2
    FQDN_NO_UPDATE = 4
    FQDN_SERV_UPDATE = 1
...
class IPAddressCmpFlags(GObject.GFlags):
    NONE = 0
    WITH_ATTRS = 1

class IPRoutingRuleAsStringFlags(GObject.GFlags):
    AF_INET = 1
    AF_INET6 = 2
    NONE = 0
    VALIDATE = 4

class IPTunnelFlags(GObject.GFlags):
...
class KeyfileHandlerFlags(GObject.GFlags):
    NONE = 0

class ManagerReloadFlags(GObject.GFlags):
    CONF = 1
    DNS_FULL = 4
    DNS_RC = 2

class MptcpFlags(GObject.GFlags):
...
class RadioFlags(GObject.GFlags):
    NONE = 0
    WLAN_AVAILABLE = 1
    WWAN_AVAILABLE = 2

class SecretAgentCapabilities(GObject.GFlags):
    LAST = 1
    NONE = 0
    VPN_HINTS = 1

class SecretAgentGetSecretsFlags(GObject.GFlags):
    ALLOW_INTERACTION = 1
    NONE = 0
...
class Setting8021xAuthFlags(GObject.GFlags):
    ALL = 511
    NONE = 0
    TLS_1_0_DISABLE = 1
    TLS_1_0_ENABLE = 32
...
class SettingDcbFlags(GObject.GFlags):
    ADVERTISE = 2
    ENABLE = 1
    NONE = 0
    WILLING = 4

class SettingEthtoolFecMode(GObject.GFlags):
    AUTO = 2
    BASER = 16
    LLRS = 32
    OFF = 4
...
class SettingSecretFlags(GObject.GFlags):
    AGENT_OWNED = 1
    NONE = 0
    NOT_REQUIRED = 4
    NOT_SAVED = 2

class SettingWiredWakeOnLan(GObject.GFlags):
    ARP = 32
    BROADCAST = 16
    DEFAULT = 1
    IGNORE = 32768
...
class SettingWirelessSecurityWpsMethod(GObject.GFlags):
    AUTO = 2
    DEFAULT = 0
    DISABLED = 1
    PBC = 4
...
class SettingWirelessWakeOnWLan(GObject.GFlags):
    ALL = 510
    ANY = 2
    DEFAULT = 1
    DISCONNECT = 4
...
class SettingsAddConnection2Flags(GObject.GFlags):
    BLOCK_AUTOCONNECT = 32
    IN_MEMORY = 2
    NONE = 0
    TO_DISK = 1

class SettingsConnectionFlags(GObject.GFlags):
    EXTERNAL = 8
    NM_GENERATED = 2
    NONE = 0
    UNSAVED = 1
...
class SettingsUpdate2Flags(GObject.GFlags):
    BLOCK_AUTOCONNECT = 32
    IN_MEMORY = 2
...
class TeamLinkWatcherArpPingFlags(GObject.GFlags):
    SEND_ALWAYS = 8
    VALIDATE_ACTIVE = 2
    VALIDATE_INACTIVE = 4

class VlanFlags(GObject.GFlags):
    GVRP = 2
    LOOSE_BINDING = 4
    MVRP = 8
    REORDER_HEADERS = 1

class VpnEditorPluginCapability(GObject.GFlags):
    EXPORT = 2
    IMPORT = 1
    IPV6 = 4
    NONE = 0
...
class ActiveConnectionState(GObject.GEnum):
    ACTIVATED = 2
    ACTIVATING = 1
    DEACTIVATED = 4
    DEACTIVATING = 3
...
class ActiveConnectionStateReason(GObject.GEnum):
...
class AgentManagerError(GObject.GEnum):
    FAILED = 0
    INVALIDIDENTIFIER = 2
    NOSECRETS = 4
    NOTREGISTERED = 3
...
class Capability(GObject.GEnum):
    OVS = 2
    TEAM = 1
...
class ClientPermission(GObject.GEnum):
...
class ClientPermissionResult(GObject.GEnum):
    AUTH = 2
    NO = 3
    UNKNOWN = 0
    YES = 1

class ConnectionError(GObject.GEnum):
    FAILED = 0
    INVALIDPROPERTY = 7
    INVALIDSETTING = 5
    MISSINGPROPERTY = 6
...
class ConnectionMultiConnect(GObject.GEnum):
    DEFAULT = 0
    MANUAL_MULTIPLE = 2
    MULTIPLE = 3
    SINGLE = 1

class ConnectivityState(GObject.GEnum):
    FULL = 4
    LIMITED = 3
    NONE = 1
    PORTAL = 2
...
class CryptoError(GObject.GEnum):
    DECRYPTION_FAILED = 4
    ENCRYPTION_FAILED = 5
    FAILED = 0
    INVALID_DATA = 1
...
class DeviceStateReason(GObject.GEnum):
    AUTOIP_ERROR = 21
    AUTOIP_FAILED = 22
...
class IPTunnelMode(GObject.GEnum):
    GRE = 2
    GRETAP = 10
    IP6GRE = 8
    IP6GRETAP = 11
...
class KeyfileHandlerType(GObject.GEnum):
    WARN = 1
    WRITE_CERT = 2

class KeyfileWarnSeverity(GObject.GEnum):
    DEBUG = 1000
    INFO = 2000
    INFO_MISSING_FILE = 2901
    WARN = 3000

class ManagerError(GObject.GEnum):
...
class RollbackResult(GObject.GEnum):
    ERR_DEVICE_UNMANAGED = 2
    ERR_FAILED = 3
    ERR_NO_DEVICE = 1
    OK = 0

class SecretAgentError(GObject.GEnum):
    AGENTCANCELED = 4
    FAILED = 0
    INVALIDCONNECTION = 2
    NOSECRETS = 5
...
class Setting8021xCKFormat(GObject.GEnum):
    PKCS12 = 3
    RAW_KEY = 2
    UNKNOWN = 0
    X509 = 1

class Setting8021xCKScheme(GObject.GEnum):
    BLOB = 1
    PATH = 2
    PKCS11 = 3
    UNKNOWN = 0

class SettingCompareFlags(GObject.GEnum):
...
class SettingConnectionAutoconnectSlaves(GObject.GEnum):
    DEFAULT = -1
    NO = 0
    YES = 1

class SettingConnectionDnsOverTls(GObject.GEnum):
    DEFAULT = -1
    NO = 0
    OPPORTUNISTIC = 1
    YES = 2

class SettingConnectionDownOnPoweroff(GObject.GEnum):
    DEFAULT = -1
    NO = 0
    YES = 1

class SettingConnectionLldp(GObject.GEnum):
    DEFAULT = -1
    DISABLE = 0
    ENABLE_RX = 1

class SettingConnectionLlmnr(GObject.GEnum):
    DEFAULT = -1
    NO = 0
    RESOLVE = 1
    YES = 2

class SettingConnectionMdns(GObject.GEnum):
    DEFAULT = -1
    NO = 0
    RESOLVE = 1
    YES = 2

class SettingDiffResult(GObject.GEnum):
    IN_A = 1
    IN_A_DEFAULT = 4
    IN_B = 2
    IN_B_DEFAULT = 8
...
class SettingIP4DhcpIpv6OnlyPreferred(GObject.GEnum):
    DEFAULT = -1
    NO = 0
    YES = 1

class SettingIP4LinkLocal(GObject.GEnum):
    AUTO = 1
    DEFAULT = 0
    DISABLED = 2
    ENABLED = 3
...
class SettingIP6ConfigAddrGenMode(GObject.GEnum):
    DEFAULT = 3
    DEFAULT_OR_EUI64 = 2
    EUI64 = 0
    STABLE_PRIVACY = 1

class SettingIP6ConfigPrivacy(GObject.GEnum):
    DISABLED = 0
    PREFER_PUBLIC_ADDR = 1
    PREFER_TEMP_ADDR = 2
    UNKNOWN = -1

class SettingIPConfigRoutedDns(GObject.GEnum):
    DEFAULT = -1
    NO = 0
    YES = 1

class SettingIpvlanMode(GObject.GEnum):
    L2 = 1
    L3 = 2
    L3S = 3
    UNKNOWN = 0

class SettingMacRandomization(GObject.GEnum):
    ALWAYS = 2
    DEFAULT = 0
    NEVER = 1

class SettingMacsecMode(GObject.GEnum):
    EAP = 1
    PSK = 0

class SettingMacsecOffload(GObject.GEnum):
    DEFAULT = -1
    MAC = 2
    OFF = 0
    PHY = 1

class SettingMacsecValidation(GObject.GEnum):
    CHECK = 1
    DISABLE = 0
    STRICT = 2

class SettingMacvlanMode(GObject.GEnum):
    BRIDGE = 2
    PASSTHRU = 4
    PRIVATE = 3
    SOURCE = 5
...
class SettingProxyMethod(GObject.GEnum):
    AUTO = 1
    NONE = 0

class SettingSerialParity(GObject.GEnum):
    EVEN = 1
    NONE = 0
    ODD = 2

class SettingTunMode(GObject.GEnum):
    TAP = 2
    TUN = 1
    UNKNOWN = 0

class SettingWirelessChannelWidth(GObject.GEnum):
    AUTO = 0

class SettingWirelessPowersave(GObject.GEnum):
    DEFAULT = 0
    DISABLE = 2
    ENABLE = 3
    IGNORE = 1

class SettingWirelessSecurityFils(GObject.GEnum):
    DEFAULT = 0
    DISABLE = 1
    OPTIONAL = 2
    REQUIRED = 3

class SettingWirelessSecurityPmf(GObject.GEnum):
    DEFAULT = 0
    DISABLE = 1
    OPTIONAL = 2
    REQUIRED = 3

class SettingsError(GObject.GEnum):
    FAILED = 0
    INVALIDARGUMENTS = 7
    INVALIDCONNECTION = 3
    INVALIDHOSTNAME = 6
...
class SriovEswitchEncapMode(GObject.GEnum):
    BASIC = 1
    NONE = 0
    PRESERVE = -1

class SriovEswitchInlineMode(GObject.GEnum):
    LINK = 1
    NETWORK = 2
    NONE = 0
    PRESERVE = -1
...
class SriovEswitchMode(GObject.GEnum):
    LEGACY = 0
    PRESERVE = -1
    SWITCHDEV = 1

class SriovVFVlanProtocol(GObject.GEnum):
...
class Ternary(GObject.GEnum):
    DEFAULT = -1
    FALSE = 0
    TRUE = 1

class UtilsSecurityType(GObject.GEnum):
    DYNAMIC_WEP = 4
    INVALID = 0
    LEAP = 3
    NONE = 1
...
class VersionInfoCapability(GObject.GEnum):
    TABLE = 0

class VlanPriorityMap(GObject.GEnum):
    EGRESS_MAP = 1
    INGRESS_MAP = 0

class VpnConnectionState(GObject.GEnum):
    ACTIVATED = 5
    CONNECT = 3
    DISCONNECTED = 7
    FAILED = 6
...
class VpnConnectionStateReason(GObject.GEnum):
    CONNECTION_REMOVED = 11
    CONNECT_TIMEOUT = 6
    DEVICE_DISCONNECTED = 3
    IP_CONFIG_INVALID = 5
...
class VpnPluginError(GObject.GEnum):
    ALREADYSTARTED = 2
    ALREADYSTOPPED = 4
    BADARGUMENTS = 6
    FAILED = 0
...
class VpnPluginFailure(GObject.GEnum):
    BAD_IP_CONFIG = 2
    CONNECT_FAILED = 1
    LOGIN_FAILED = 0

class VpnServiceState(GObject.GEnum):
    INIT = 1
    SHUTDOWN = 2
    STARTED = 4
    STARTING = 3
...
class WepKeyType(GObject.GEnum):
    KEY = 1
    PASSPHRASE = 2
    UNKNOWN = 0

class WimaxNspNetworkType(GObject.GEnum):
    HOME = 1
    PARTNER = 2
    ROAMING_PARTNER = 3
    UNKNOWN = 0
